            ...
            <div class="form-row">
                <div class="col-md-6 mb-3">
                    ...
                    <select name="jenis_kelamin" class="custom-select custom-select-sm my-1 mr-sm-2" id="validationJenisKelamin">
                        ...
                        <option value="{{ $jenis_kelamin->id }}" {{ old('jenis_kelamin') == $jenis_kelamin->id ? 'selected' : '' }}>{{ $jenis_kelamin->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <select name="agama" class="custom-select custom-select-sm my-1 mr-sm-2" id="validationAgama">
                        ...
                        <option value="{{ $agama->id }}" {{ old('agama') == $agama->id ? 'selected' : '' }}>{{ $agama->name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
